...
def transform2tfrecord(data_folder, tfrecord_name, output_directory, resize_width, resize_height):
    ...
    for vedio_folder in vedio_folder_list:
        vedio_index += 1
        filename = os.path.join(output_directory, tfrecord_name + str(vedio_index) + '.tfrecords')
        ...
        writer.close()
        print(tfrecord_name + str(vedio_index) + '.tfrecords'+" is written to "+output_directory)



    
if __name__ == "__main__":
    transform2tfrecord("data", "train_single_vedio", "output", resize_width = 700, resize_height = 700)
